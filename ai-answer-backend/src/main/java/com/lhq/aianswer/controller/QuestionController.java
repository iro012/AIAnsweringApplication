...
import com.lhq.aianswer.manager.AiManager;
...
public class QuestionController {
     ...
     * @return
     */
    private String getGenerateQuestionSystemMessage(App app, Integer questionNumber, Integer optionNumber) {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        // AI生成
        String result = aiManager.doSyncStableRequest(GENERTE_QUESTION_SYSTEM_MESSAGE, userMessage);
        // 结果处理
